...
<center><h2>Lesson 7:How to use Zoom: Basics</h2>
<iframe   width= "75%" height="600" src="lesson7.mp4"> </iframe>
</br>
<a href="lesson6.php" class="btn btn-primary">Back</a>
<a href="lesson8.php" class="btn btn-primary">Next</a>
</center>
	</div>
	<!-- End Login Section -->

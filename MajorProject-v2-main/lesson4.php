...
<center><h2>Lesson 4:Smartphone Basics (Android)</h2>
<iframe  width= "75%" height="600" src="lesson4.mp4"> </iframe>
</br>
<a href="lesson3.php" class="btn btn-primary">Back</a>
<a href="lesson5.php" class="btn btn-primary">Next</a>
</center>
	<!-- End Login Section -->
    <!-- ======= Contact Section ======= -->
